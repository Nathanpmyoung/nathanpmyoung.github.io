...
- My current focus
	- Feel the rhymth
	- Have several choices at any position
- How I think about moves
	- Start
		- Walzish hold
		- Swizzle behind back
		- Push spin with hand crossover
			- Hands are in that very strange position
				- flick round to the right and split hands
				- flick all the way round (not very good at this) - area to work on
		- Could do with more
		- Change to other hand
			- Flip switch
			- Overhead
			- What used to be called man spin
		- Get to right hand flung out
			- Basket and fling out
	- Left hand
		- Spin behind back
