...
- Theseus and the Minotaur - *I wrote this for [[Dad]]*
  collapsed:: true
	- This tale, which long, but often told,
	  ...
	  The boy played Zeus and mated twice.
	  This irked a tad.
	  Zeus was mad.
	  ...
	  King Minos (Crete) was not aligned.
...
- Forgetting
  collapsed:: true
	- I love you
	  ...
	  Idly hoping for you to change your mind
	  I will not try to bump into you at train stations
	  Or near your house
	  I will not try to become better
	  To get big muscles so one day you can be impressed
	  Or to become prime minister 
	  So you are forced to say "I knew him once"
	  I will live my life as if you do not exist
	  I will become more beautiful for me
	  Not as some tawdry push
	  I love you
	  But I also love me
	  So this must end
...
- Rowing
  collapsed:: true
	- Sometime when it’s windy we go rowing in the rain,
	  Four frozen freshers vainly vying for some semblance that they’re sane,
	  Nervous knee high waves encroaching on the boundaries of our boat,
	  With our bow side Archimedes calculating if we’ll float,
	  
	  I’m either worrying that I’m hurrying or my blade is feeling slack,
	  As our cox’s desperate voxings take the long way to the back.
	  Sternly, I’m reminded, that we should all row together,
	  For four oars are in our hands, despite the sailing kind of weather,
	  
	  The the group catches in unison, and I’m shock that we’re so fast,
...
- Christmas
  collapsed:: true
	- If Christmas were a particle,
	  ...
	  Though maybe quirks instead of quarks,
	  And rather more than three,
	  It seems to have a purpose,
	  And if you’re Catholic, mass,
	  One you find its presents,
	  Uncertainty is crass,
	  I’m sure that it is positive,
	  And also fundamental,
	  Spanning all of space and time,
	  Its value, transcendental,
	  You need no strange devices,
	  Just your family will do,
	  Learn to love one another,
	  Give a present to your brother,
	  And collapse a waveform or two.
- # Poems by others
- Robinson Crusoe's Story by [[Charles Carryl]]
  collapsed:: true
	- *I love this poem because it was in a big book of silly poems that my [[Dad]] read to me as a child. He sang it to a tune and it was great.*
